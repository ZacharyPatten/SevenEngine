...
namespace Engine.DataStructures
{
  ...
  //{
  //  private int _count;
  //  private Link<int, T>[] _queueArray;
  ...
  //      else throw new PriorityQueueException("Attempting to peek at an empty priority queue.");
  //    }
  //  }
  ...
  //    _queueArray = new Link<int, T>[max + 1];
  //    _queueArray[0] = new Link<int, T>(int.MaxValue, default(T));
  //    _count = 0;
  //  }
  ...
  //    {
  //      _queueArray[_count + 1] = new Link<int, T>(priority, addition);
  //      _indexingReference.Add(addition, _count + 1);
  //      ShiftPositive(_count + 1);
  //      _count++;
  //    }
  //    else throw new PriorityQueueException("Attempting to add to a full priority queue.");
  //  }
  ...
  //      return removal;
  //    }
  //    else throw new PriorityQueueException("Attempting to dequeue from an empty priority queue.");
  //  }

  //  public void IncreasePriority(T item)
  //  {
  //    int index = _indexingReference[item];
  //    _queueArray[index] = new Link<int, T>(_queueArray[index].Left + 1, item);
  //    ShiftPositive(index);
  //  }
  ...
  //  {
  //    Link<int, T> swapStorage = _queueArray[indexTwo];
  ...
  //  private class PriorityQueueException : Exception { public PriorityQueueException(string message) : base(message) { } }
  //}
}