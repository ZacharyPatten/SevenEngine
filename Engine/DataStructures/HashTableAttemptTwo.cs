...
namespace Engine.DataStructures
{
  public class Hashtable
  {
    ...
    {
      // THE FOLLOWING COMMENTED LINE IS NEEDED, but for this "HashTable" class 
      // I already checked if candidate was equal to 2 for a speed boost
    ...
    {
      Hashtable hashTable = new Hashtable(_capacity);
